...
class ModelController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $models = $em->getRepository('AutoBundle:Model')->findAll();
    ...
    {
        $model = new Model();
        $form = $this->createForm('AutoBundle\Form\ModelType', $model);
    ...
    {
        $deleteForm = $this->createDeleteForm($model);
        $editForm = $this->createForm('AutoBundle\Form\ModelType', $model);
