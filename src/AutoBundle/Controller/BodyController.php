...
class BodyController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $bodies = $em->getRepository('AutoBundle:Body')->findAll();
    ...
    {
        $body = new Body();
        $form = $this->createForm('AutoBundle\Form\BodyType', $body);
    ...
    {
        $deleteForm = $this->createDeleteForm($body);
        $editForm = $this->createForm('AutoBundle\Form\BodyType', $body);
